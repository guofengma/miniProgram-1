...
App({
  ...
  globalData: {
    userInfo: null,
    token:"",
    servsers: "https://erp.mengjingqihua.com/ruiz/"  //https://erp.mengjingqihua.com  //http://dream.ruiztech.cn  //http://192.168.61.5:8080
  },
  // 获取未读条数
  getUnRead:function(){
  ...
  // 图片加载错误显示默认图片
  imgError: function (e,that) {
    console.log(e)
    var index = e.target.dataset.index;
    var list = that.data.list;
    list[index]["img"] = "/images/errImg.png"
    that.setData({
      list: list
    })
  },
  // 图片加载错误显示默认图片
  imgError2: function (e, that) {
    console.log(e)
    var index = e.target.dataset.index;
    var info = that.data.info;
    info.applyMaterialList[index]["img"] = "/images/errImg.png"
    that.setData({
      info: info
    })
  },

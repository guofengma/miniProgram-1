...
Page({
  ...
  goDetail: function (id) {
    wx.navigateTo({
      // url: '../taskDetail_finished/taskDetail_finished',
  ...
  dataProcessing: function (data, page) {
    ...
    for (var i = 0; i < dataList.length; i++) {
      ...
      var completeDate = (isOpen == 1)?dataList[i].specialCompleteDate:dataList[i].completeDate;

      dataList[i].completeDate = completeDate.slice(0, 10)
